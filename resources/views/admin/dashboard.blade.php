                            ...
                            <div class="card-block">
                                <div class="row m-b-25">
                                    <div class="col-auto p-r-0">
                                        <div class="u-img">
                                            <img src="{{ asset('admin/files/assets/images/breadcrumb-bg.jpg') }}"
                                                 alt="user image" class="img-radius cover-img">
                                            <img src="{{ asset('admin/files/assets/images/avatar-2.jpg') }}"
                                ...
                                <div class="row m-b-25">
                                    <div class="col-auto p-r-0">
                                        <div class="u-img">
                                            <img src="{{ asset('admin/files/assets/images/breadcrumb-bg.jpg') }}"
                                                 alt="user image" class="img-radius cover-img">
                                            <img src="{{ asset('adminty-html/files/assets/images/avatar-2.jpg') }}"
                                                 alt="user image" class="img-radius profile-img">
                                        </div>
                                    </div>
                                    <div class="col">
                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-4 bg-c-lite-green user-profile">
                                    <div class="card-block text-center text-white">
                                        <div class="m-b-25">
                                            <img src="{{ asset('admin/files/assets/images/avatar-4.jpg') }}"
