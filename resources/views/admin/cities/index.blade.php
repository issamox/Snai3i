                 ...
                 <div class="col-lg-6 col-xl-3 col-md-6">
                    <div class="card rounded-card user-card">
                        <div class="card-block">
                            <div class="img-hover">
                                <img class="img-fluid img-radius" src='{{ $city->image ? asset("uploads/Admin/Cities/$city->image") : asset('admin/files/assets/images/default-image.png') }}' alt="round-img">
                                <div class="img-overlay img-radius">
                                    <span>
                                        <a href="{{ route('cities.edit', $city->id ) }}" class="btn btn-sm btn-primary" data-popup="lightbox"><i class="feather icon-edit-1"></i></a>
                                        <a href="" class="btn btn-sm btn-danger btn_delete"><i class="feather icon-trash"></i></a>

                                          <form method="post" action="{{ route('cities.destroy',$city->id) }}" class="delete_form" style="display: none">
                                              @csrf
                                              @method("delete")
